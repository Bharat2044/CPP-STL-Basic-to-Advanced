...
int main() {
    ...
    cout << "Printing vector elements in reverse order:\n";
    ...
    cout << "After updating  vector elements are:\n";
    for(auto it = arr.begin(); it!=arr.end(); it++)
        cout << *it << "  ";
    cout << endl;
    ...
    for(vector<int> :: reverse_iterator it2=arr.rbegin(); it2!=arr.rend(); it2++)
        cout << *it2 << "  ";
    cout << endl;
    ...
    cout << "\n\n3. Const Iteraror =====>\n";
    // vector<int, 6> :: const_iterator it3 = arr.begin(); // OR
    vector<int> :: const_iterator it3 = arr.cbegin(); 
    ...
    for(vector<int> :: const_iterator it3=arr.begin(); it3!=arr.end(); it3++)
        cout << *it3 << "  ";
    cout << endl;
    ...
    vector<int> :: const_reverse_iterator it4 = arr.rbegin();
    ...
    for(vector<int> :: const_reverse_iterator it4=arr.rbegin(); it4!=arr.rend(); it4++)
        cout << *it4 << "  ";
    cout << endl;
